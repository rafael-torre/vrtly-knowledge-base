...
- When 'A' selected: Invoke the `skill-elicitation` skill
- When 'P' selected: Invoke the `skill-roundtable` skill
...
- Invoke the `skill-elicitation` skill with current category rules
...
- Invoke the `skill-roundtable` skill with category rules context
